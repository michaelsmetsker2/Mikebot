...
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="datasichael",
    path=os.path.abspath("./datasichael"),
...
SPEAKER_REFERENCE = [
    "./datasichael/wavs/001.wav"  # speaker reference to be used in training test sentences
]
